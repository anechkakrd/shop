...
function BasketList(props) {
    ...
    return (
        <ul className="collection basket-list">
            <li className="collection-item active #6a1b9a purple darken-3"><h5>Корзина</h5></li>
            {order.length ? (
            ...
            <li className="collection-item active #6a1b9a purple darken-3"><h5>Общая стоимость заказа: {totalPrice} р</h5></li>
